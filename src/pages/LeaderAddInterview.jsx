  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, width: "100vw", overflowX: "hidden" }}>
      ...
      <div className="container-fluid py-5" style={{ maxWidth: "1400px" }}>
        <h2 className="fw-bold mb-4 text-center" style={{ color: BLUE_DARK, fontSize: 30 }}>
          ...
          >
            ...
            >
              <div className="d-flex align-items-center mb-3">
                ...
                <div>
                  <h5 className="fw-bold mb-1" style={{ fontSize: 22, color: BLUE_DARK }}>
                    {club.clubName}
                  </h5>
                  <div style={{ color: "#1e3a8a", fontWeight: 500, fontSize: 15 }}>
              ...
              <form onSubmit={handleSubmit} className="mt-3">
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: BLUE_DARK }}>
                    Tên ứng viên
                  </label>
                  <input
                    type="text"
            ...
            >
              <h4 className="fw-bold mb-3" style={{ color: BLUE_DARK }}>
      ...
      <footer style={{ backgroundColor: BLUE_DARK }} className="text-white text-center py-3 mt-0">
...
export default LeaderAddInterview;
